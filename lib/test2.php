...
<body class="body" style="background-color:#282C35">	
 ...
 <ul>
  ...
  <li><a href="../home" ><button class="btn btn-primary" >Go Back</button></a></li>
       ...
       <div class="panel-heading"><h4>Stress Test Panel</h4><div style="text-align:right;" >          Dissertation of Alex Mavromatis.
<img src="../img/info2.png" style="position: color:#B95400;  class="btn btn-primary" data-toggle="modal" data-target="#info" width="60px" height="40px"></img></div></div>
